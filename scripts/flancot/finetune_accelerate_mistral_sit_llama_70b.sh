...
TRAIN_FILE=self-seq/data/flancot_full/flancot_100k-iteration_1.jsonl
...
accelerate launch \
    ...
    --weight_decay 0. \
    --num_train_epochs 2 \
    --output_dir output/self-seq-${MODEL_NAME}-flancot_full_sit_llama_70b/ \
...
bash scripts/evaluation.sh output/self-seq-${MODEL_NAME}-flancot_full_sit_llama_70b
